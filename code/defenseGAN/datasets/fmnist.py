...
"""Contains the class for handling the F-MNIST dataset."""
...
class FMnist(Dataset):
    """Implements the Dataset class to handle F-MNIST.
    ...
    def __init__(self):
        ...
        super(FMnist, self).__init__('f-mnist')
        self.y_dim = 10
        self.split_data = {}

    def load(self, split='train', lazy=False, randomize=True):
        ...
        if split in list(self.split_data.keys()):
