...
def load(batch_size, test_batch_size, n_labelled=None,randomize=True):
    ...
    return (
        mnist_generator(train_data, batch_size, n_labelled,randomize=randomize),
        mnist_generator(dev_data, test_batch_size, n_labelled,randomize=randomize),
        mnist_generator(test_data, test_batch_size, n_labelled,randomize=randomize)
    )
